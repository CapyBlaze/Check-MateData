...
function App() {
    ...
    return (
        <>
            ...
            {/* Header */}
            <div className="flex flex-col items-center flex-nowrap mb-8 relative">
            ...
            <div 
                ...
                `}
            >
                <div className="w-screen flex flex-col lg:flex-row gap-6 max-w-4xl justify-center items-center">
                    <FileUploadCard
                        title="File to PGN"
                ...
                <div className="w-screen flex flex-col lg:flex-row gap-6 max-w-4xl justify-center items-center">
                    <div 
                        className="opacity-50 absolute left-1/2 m-9 cursor-pointer"
            ...
            <a href="https://github.com/CapyBlaze/Check-MateData" target="_blank" rel="noopener noreferrer">
                <div className="opacity-50 absolute bottom-4 right-4 cursor-pointer hover:opacity-80 transition-all duration-300">
